<?php
	class pengajuan_persetujuan {
		...
		public function cari($cari){
			if((int)$cari==0){
				$sql = "SELECT pengajuan_persetujuan.kode_pengajuan_persetujuan, jenis.nama_jenis, pengajuan_persetujuan.jumlah_barang, satuan.nama_satuan, pengajuan_persetujuan.tgl_pengajuan, pengajuan_persetujuan.tgl_disetujui, pegawai.nama_pegawai, pengajuan_persetujuan.keterangan from pengajuan_persetujuan join jenis on jenis.kode_jenis=pengajuan_persetujuan.kode_jenis join pegawai on pegawai.nipp=pengajuan_persetujuan.nipp join satuan on satuan.kode_satuan=pengajuan_persetujuan.kode_satuan where  pengajuan_persetujuan.kode_pengajuan_persetujuan LIKE '%$cari%' OR jenis.nama_jenis LIKE '%$cari%' OR pengajuan_persetujuan.jumlah_barang LIKE '%$cari%' OR satuan.nama_satuan LIKE '%$cari%'  OR pengajuan_persetujuan.jumlah_barang=$cari OR pegawai.nama_pegawai LIKE '%$cari%' OR pengajuan_persetujuan.keterangan LIKE '%$cari%' ";
			}else{
				//ada integer
				$sql = "SELECT pengajuan_persetujuan.kode_pengajuan_persetujuan, jenis.nama_jenis, pengajuan_persetujuan.tgl_pengajuan_persetujuan, pengajuan_persetujuan.jumlah_barang, pegawai.nama_pegawai, pengajuan_persetujuan.keterangan from pengajuan_persetujuan join jenis on jenis.kode_jenis=pengajuan_persetujuan.kode_jenis join pegawai on pegawai.nipp=pengajuan_persetujuan.nipp where  pengajuan_persetujuan.kode_pengajuan_persetujuan LIKE '%$cari%' OR jenis.nama_jenis LIKE '%$cari%' OR EXTRACT('day' FROM pengajuan_persetujuan.tgl_pengajuan_persetujuan)='$cari' OR EXTRACT('month' FROM pengajuan_persetujuan.tgl_pengajuan_persetujuan)='$cari' OR EXTRACT('year' FROM pengajuan_persetujuan.tgl_pengajuan_persetujuan)='$cari' OR pengajuan_persetujuan.jumlah_barang=$cari OR pegawai.nama_pegawai LIKE '%$cari%' OR pengajuan_persetujuan.keterangan LIKE '%$cari%' ";
			}
			// die($sql);
			$hasil = pg_query($sql);
			return $hasil;
