<?php
	...
	if(isset($_GET['aksi'])){
		$aksi = $_GET['aksi'];
		if ($aksi =="tambah") {
			$db->input($_POST['kode_pengajuan_persetujuan'], $_POST['kode_jenis'], $_POST['jumlah_barang'], $_POST['kode_satuan'], $_POST['tgl_pengajuan'], $_POST['tgl_disetujui'], $_POST['nipp'], $_POST['keterangan']);
		}
		elseif ($aksi == "delete") {
			$db->delete($_GET['id']);
		}
